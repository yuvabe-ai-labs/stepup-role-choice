          ...
          {loading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {units.map((unit) => {
                ...
                return (
                  <Card key={unit.id} className="overflow-hidden shadow border border-gray-200 rounded-xl hover:shadow-md transition-shadow cursor-pointer">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="flex flex-col">
                              ...
                              {unit.is_aurovillian && (
                                <Badge className="text-[10px] bg-green-100 text-green-700 w-fit rounded-md px-2 py-0.5">
                                  Aurovillian
                                </Badge>
                              )}
                            </div>
