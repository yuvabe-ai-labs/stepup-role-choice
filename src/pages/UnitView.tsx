...
//           <div className="relative h-48 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10" />

//           <CardContent className="relative -mt-16 px-8 pb-8">
//             <div className="flex flex-col md:flex-row items-start md:items-end gap-6">
//               {/* Unit Logo */}
//               <div className="w-32 h-32 rounded-full bg-background border-4 border-background shadow-lg flex items-center justify-center text-4xl font-bold text-foreground overflow-hidden">
//                 {unit.image ? (
//                   <img src={unit.image} alt={unit.unit_name} className="w-full h-full object-cover" />
//                 ) : (
//                   unit.unit_name.charAt(0)
...
//                     return (
//                       <Card key={internship.id} className="border-border hover:shadow-md transition-shadow">
//                         <CardContent className="p-6">
//                           <div className="flex items-start gap-4">
//                             {/* Internship Icon */}
//                             <div className="w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center flex-shrink-0">
...
//                 <h3 className="text-lg font-semibold text-foreground mb-3">Our Mission</h3>
//                 <p className="text-muted-foreground leading-relaxed">
//                   {unit.mission || 'To create meaningful impact through innovative solutions and sustainable practices.'}
//                 </p>
//               </div>
