...
import { Eye, EyeOff, GraduationCap, Building, Check, X } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="text-center mb-8">
              <Link to="/" className="inline-flex items-center space-x-2 text-2xl font-bold text-primary mb-6">
                <span>StepUp</span>
              </Link>
              <div className="flex items-center justify-center space-x-2 mb-4">
                <RoleIcon className="w-6 h-6 text-primary" />
                <span className="text-lg font-medium capitalize text-muted-foreground">{role}</span>
              </div>
            </div>

            <Card className="shadow-xl border-0">
              <CardHeader className="text-center pb-4">
                <CardTitle className="text-2xl font-bold">Create your StepUp Account</CardTitle>
                <p className="text-muted-foreground mt-2">Please enter your details below</p>
              </CardHeader>
