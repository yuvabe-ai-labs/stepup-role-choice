...
export const InterestDialog: React.FC<InterestDialogProps> = ({ children, interests, onSave }) => {
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex space-x-2">
              ...
              />
              <Button type="button" onClick={addInterest} size="sm" className="rounded-full">
                Add
              </Button>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button onClick={handleSave} disabled={isSubmitting} className="rounded-full">
