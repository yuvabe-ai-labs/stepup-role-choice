...
interface UnitDetailsAndDescriptionDialogProps {
  profile: any;
  unitProfile: any;
...
export const UnitDetailsAndDescriptionDialog = ({
  profile,
  unitProfile,
  onUpdate,
  onUpdateUnit,
  onSaveDescription,
  children,
}: UnitDetailsAndDescriptionDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Update description
    await onSaveDescription(formData.description);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Unit Details & Description</DialogTitle>
        </DialogHeader>
